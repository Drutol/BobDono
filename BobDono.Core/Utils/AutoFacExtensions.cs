...
namespace BobDono.Core.Utils
{
    public static class AutoFacExtensions
    {
        ...
        public class FactoryDelegate<TLimit, TActivatorData, TRegistrationStyle>
        {
            ...
            public IRegistrationBuilder<TLimit, TActivatorData, TRegistrationStyle> WithProduct<TProduct>()
                where TProduct : class, IServiceFactory<TProduct>
            {
                return _builder.As<IServiceFactory<TProduct>>();
            }
        }

        public static FactoryDelegate<TLimit, TActivatorData, TRegistrationStyle> AsFactory<TLimit, TActivatorData,
            TRegistrationStyle>(
